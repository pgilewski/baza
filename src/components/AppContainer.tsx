    ...
    <div className="h-screen w-full homeBg text-center align-middle mx-auto">
      <div className="flex-row justify-center">
        ...
        <div className="font-mono text-xl pt-4 text-white">
          Crete groups, add entries <br />and get random roll.
        </div>
        <div className="flex flex-col font-mono justify-center mx-auto mt-4 text-black  text-lg">
          <input onChange={onChange} type="text" name="username" placeholder='login' className="placeholder-black transition-colors hover:transition-colors bg-purple focus:bg-blue-800  p-3 my-1 w-60 mx-auto cursor-pointer"/>
          ...
          <div onClick={() => login(formState)}className="px-8 bg-gradient-to-r  from-purple-600 to-blue-500 transition-colors hover:transition-colors bg-white hover:bg-gray-400 cursor-pointer p-3 my-6 md:my-4 mx-auto text-black text-center">
             GET IN
          </div>
        </div>
      </div>
